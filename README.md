...
# Dotpulse.Button Package for Neos CMS #

## Composer

### Integration Repository
```
composer config repositories.button vcs ssh://hg@bitbucket.org/dotpulse/neos-plugin-button
```

### Installation
```
composer require dotpulse/button
```
* * *
> ##### License Terms
